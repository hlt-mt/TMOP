...
class ReverseWordRatio(AbstractFilter):
	def __init__(self):
		self.var_mult = 2
...
#
	def initialize(self, source_language, target_language, extra_args):
		...
		self.model_filename = "models/" + extra_args['input filename'] + "__ReverseWordRatio.stats"
		if self.normalize:
	...
	def process_tu(self, tu, num_of_finished_scans):
		...
		ratio = trg_size / max(src_size, 1.0)
