...
class ReverseLengthRatio(AbstractFilter):
	def __init__(self):
		self.var_mult = 2
...
#
	def initialize(self, source_language, target_language, extra_args):
		...
		self.model_filename = "models/" + extra_args['input filename'] + "__ReverseLengthRatio.stats"
		if self.normalize:
